...
class PConvUnet(object):
    ...
    def build_pconv_unet(self, train_bn=True):      
        ...
        #e_conv1 = non_local_block(e_conv1, compression=4, mode='dot', add_residual=False)
        e_conv2, e_mask2 = encoder_layer(e_conv1, e_mask1, 128, 5)
        e_conv2 = non_local_block(e_conv2, compression=2, mode='dot', add_residual=False)
        e_conv3, e_mask3 = encoder_layer(e_conv2, e_mask2, 256, 5)
        e_conv3 = non_local_block(e_conv3, compression=2, mode='dot', add_residual=False)
        e_conv4, e_mask4 = encoder_layer(e_conv3, e_mask3, 512, 5)
        e_conv4 = non_local_block(e_conv4, compression=2, mode='dot', add_residual=False)
        #e_conv5, e_mask5 = encoder_layer(e_conv4, e_mask4, 512, 5)
        #e_conv6, e_mask6 = encoder_layer(e_conv5, e_mask5, 512, 5)
        #e_conv7, e_mask7 = encoder_layer(e_conv6, e_mask6, 512, 5)
        #e_conv8, e_mask8 = encoder_layer(e_conv7, e_mask7, 512, 5)
        ...
        #d_conv9, d_mask9 = decoder_layer(e_conv8, e_mask8, e_conv7, e_mask7, 512, 5)
        #d_conv10, d_mask10 = decoder_layer(d_conv9, d_mask9, e_conv6, e_mask6, 512, 5)
        #d_conv11, d_mask11 = decoder_layer(d_conv10, d_mask10, e_conv5, e_mask5, 512, 5)
        #d_conv12, d_mask12 = decoder_layer(d_conv11, d_mask11, e_conv4, e_mask4, 512, 5)
        d_conv5, d_mask5 = decoder_layer(e_conv4, e_mask4, e_conv3, e_mask3, 256, 5)
        d_conv6, d_mask6 = decoder_layer(d_conv5, d_mask5, e_conv2, e_mask2, 128, 5)
        d_conv7, d_mask7 = decoder_layer(d_conv6, d_mask6, e_conv1, e_mask1, 64, 5)
        d_conv8, d_mask8 = decoder_layer(d_conv7, d_mask7, inputs_img, inputs_mask, 3, 5, bn=False)
        # add a non_local layer here [2020.2.21 WNY]:
        # d_conv8 = non_local_block(d_conv8, compression=2, mode='embedded')
        outputs = Conv2D(3, 1, activation = 'sigmoid', name='outputs_img')(d_conv8)
