...
class PConvUnet(object):
    ...
    def build_pconv_unet(self, train_bn=True):      
        ...
        e_conv1a, e_mask1a = encoder_layer(e_conv1a, e_mask1a, 64, 7)
        e_conv1b, e_mask1b = encoder_layer_1by1(inputs_img, inputs_mask, 64, bn=False)
        e_conv1b, e_mask1b = encoder_layer(e_conv1b, e_mask1b, 64, 5)
        e_conv1c, e_mask1c = encoder_layer(inputs_img, inputs_mask, 64, 3, bn=False)
